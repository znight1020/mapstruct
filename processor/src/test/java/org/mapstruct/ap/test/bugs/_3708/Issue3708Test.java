...
public class Issue3708Test {
    ...
    @ProcessorTest
    void shouldThrowWhenAccessorOnlyUpdatesImmutableTarget() {
        ...
        assertThatThrownBy( () -> Issue3708AccessorOnlyMapper.INSTANCE.partialUpdate( entity, dto ) )
            .isInstanceOf( UnsupportedOperationException.class );
    }

    @ProcessorTest
    void shouldReplaceWhenTargetImmutableUpdatesImmutableTarget() {
        Partner entity = new Partner();
        entity.setTypes( Set.of( "A" ) );
        PartnerDto dto = new PartnerDto();
        dto.setTypes( new LinkedHashSet<>( Set.of( "B", "C" ) ) );

        Issue3708TargetImmutableMapper.INSTANCE.partialUpdate( entity, dto );

        assertThat( entity.getTypes() ).containsExactlyInAnyOrder( "B", "C" );
    }

    @ProcessorTest
    void shouldNotGenerateClearAndAddAllWhenTargetImmutable() {
    ...
    @ProcessorTest
    void shouldGenerateClearAndAddAllWhenAccessorOnly() {
